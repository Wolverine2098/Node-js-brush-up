...
typeof process.env.NODE_ENV_M == "undefined"
  ...
  ? (mnMinbase = "https://dev-my.imimg.com")
  : process.env.NODE_ENV_M == "stg"
  ? (mnMinbase = "https://stg-my.imimg.com")
  : (mnMinbase = "https://my.imimg.com");
  ...
  return ` 
   ...
   <link rel="preconnect" href="https://${
     process.env.NODE_ENV_M == "dev"
       ...
       ? "stg-"
       : ""
   }my.imimg.com/" crossorigin > 
   <link rel="preconnect" href="https://geoip.imimg.com" crossorigin >
   
   <link rel="preload" href="${
     mnMinbase + "/pwagifs/BuyerSettings.pwa" + chunkVersion["jsChunks"] + ".js"
   }" as="script" >
   <link rel="preload" href="${
     mnMinbase +
     "/pwagifs/BuyerSettings.pwa" +
     chunkVersion["cssChunks"] +
     ".css"
   }" as="style">
   <link rel="preload" href="${
     mnMinbase + "/pwagifs/main-min_" + chunkVersion["main_min"] + ".js"
   }" as="script" >
...
function MessagesShellStruct() {
  let crumbsObj = [
    {
      ...
      potentialAction: [
        ...
        },
        {
          "@type": "SearchAction",
          target:
            "android-app://com.indiamart.m/https/m.indiamart.com/isearch.php?s={search_term_string}",
          "query-input": "required name=search_term_string",
        },
      ],
    },
  ...
  appShell.HEAD_SCRIPTS =
    `${preloadedChunks()}<script type='application/ld+json'>` +
    JSON.stringify(crumbsObj) +
    `</script>
      <style>
...
function getMessagesPage(req, res, shellCallBck) {
  MessagesShellStruct();
