...
/***/ "./src/Redux/ChangePassword/CPActions.js":
/*!***********************************************!*\
  !*** ./src/Redux/ChangePassword/CPActions.js ***!
  \***********************************************/
/*! exports provided: sendOTP, changePassword */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var sendOTP = function sendOTP(params) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _api_imApi__WEBPACK_IMPORTED_MODULE_0__["default"].fetchOTPVer(params);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _api_imApi__WEBPACK_IMPORTED_MODULE_0__["default"].fetchChangePassword(params);
...
/***/ "./src/modules/Buyer/ChangePassword/components/Password.js":
/*!*****************************************************************!*\
  !*** ./src/modules/Buyer/ChangePassword/components/Password.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Footer_components_Footer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../Footer/components/Footer */ "./src/modules/Footer/components/Footer.js");
/* harmony import */ var _loader_components_LoaderAnimation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../loader/components/LoaderAnimation */ "./src/modules/loader/components/LoaderAnimation.js");
...
/* harmony import */ var _css_Password_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../css/Password.css */ "./src/modules/Buyer/ChangePassword/css/Password.css");
/* harmony import */ var _css_Password_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_css_Password_css__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utility/PasswordUtility */ "./src/modules/Buyer/ChangePassword/utility/PasswordUtility.js");
/* harmony import */ var _Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../Globals/GlobalFunc */ "./src/Globals/GlobalFunc.js");
/* harmony import */ var _Globals_CookieManager__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../Globals/CookieManager */ "./src/Globals/CookieManager.js");
...
/* harmony import */ var _ErrorPage_components_error__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../ErrorPage/components/error */ "./src/modules/ErrorPage/components/error.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var TabNav = function TabNav(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("nav", {
    className: "tabnew"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    "class": "border"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h1", null, "Settings"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("ul", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Link"], {
    to: "/mysettingsreact",
    id: "settingsTab",
    activeClassName: "active"
  }, "Privacy Settings")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Link"], {
...
var PasswordComponent = /*#__PURE__*/function (_Component) {
  _inherits(PasswordComponent, _Component);
  ...
  function PasswordComponent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      showLoader: false,
      showSetOTPDiv: true,
      showCPotpEnter: false,
      otpMsg: '',
      otpMedium: '',
      showOtpMsg: false,
      showResendandReset: false,
      divError: '',
      showDivError: false,
      showDivSucc: false,
      displayPage: true
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangeHandle", function (e) {
      _this.setState(_defineProperty({}, e.target.name, e.target.value));
    });

    _defineProperty(_assertThisInitialized(_this), "showPassword", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "checkPass", function (e) {
      var pass = _this.state.new_pass;
      var pass1 = _this.state.conf_pass;

      if (pass == "") {
        _this.setState({
          passError: "Kindly enter your New Password.",
          showPassError: true,
          disabled: true
        });
      } else if (pass.length < 6) {
        _this.setState({
          passError: "The Password should have minimum 6 characters.",
          showPassError: true,
          disabled: true
        });
      } else if (pass.indexOf(" ") != -1) {
        _this.setState({
          passError: "Kindly enter your Password without any spaces in it.",
          showPassError: true,
          disabled: true
        });
      } else if (pass.length > 24) {
        _this.setState({
          passError: "The Password should not exceed 24 characters.",
          showPassError: true,
          disabled: true
        });
      } else if (pass != "" && pass1 != "" && pass.toUpperCase() != pass1.toUpperCase()) {
        _this.setState({
          passError: "",
          showPassError: false,
          confPassError: "Password mis-match! Kindly re-enter your New Password.",
          showConfPassError: true,
          disabled: true
        });
      } else if (pass != "" && pass1 != "" && pass.toUpperCase() == pass1.toUpperCase()) {
        _this.setState({
      ...
      if (pass.toUpperCase() != pass1.toUpperCase()) {
        _this.setState({
          start: true,
          startBg: '#eae8e8'
        }); // document.getElementById('start').disabled = true;
        // document.getElementById('start').style.background = '#eae8e8';

      }

      var x = document.getElementsByClassName("mobbox2 f1 border_black1");
      var auth_key = '';
      var auth = new Array();
      ...
      if (pass.length >= 6 && pass.length < 24 && pass.indexOf(" ") == -1 && auth_key.length == 4 && pass == pass1 && pass != "" && pass1 != "") {
        _this.setState({
          start: false,
          startBg: '#00a699'
        }); // document.getElementById('start').disabled = false;
        // document.getElementById('start').style.background = '#00a699';

      }
    });

    _defineProperty(_assertThisInitialized(_this), "checkConfPass", function (e) {
      var pass = _this.state.new_pass;
      var pass1 = _this.state.conf_pass;

      if (pass1 == "") {
        _this.setState({
          confPassError: "Kindly enter your New Password.",
          showConfPassError: true,
          disabled: true
        });
      } else if (pass1.length < 6) {
        _this.setState({
          confPassError: "The Password should have minimum 6 characters.",
          showConfPassError: true,
          disabled: true
        });
      } else if (pass1.indexOf(" ") != -1) {
        _this.setState({
          confPassError: "Kindly enter your Password without any spaces in it.",
          showConfPassError: true,
          disabled: true
        });
      } else if (pass1.length > 24) {
        _this.setState({
          confPassError: "The Password should not exceed 24 characters.",
          showConfPassError: true,
          disabled: true
        });
      } else if (pass != "" && pass1 != "" && pass.toUpperCase() != pass1.toUpperCase()) {
      ...
      if (_this.state.new_pass != _this.state.conf_pass) {
        _this.setState({
          start: true,
          startBg: '#eae8e8'
        }); // document.getElementById('start').disabled = true;
      ...
      if (auth_key.length == 4 && _this.state.new_pass == _this.state.conf_pass) {
        _this.setState({
          start: false,
          startBg: '#00a699'
        }); // document.getElementById('start').disabled = false;
    ...
    _defineProperty(_assertThisInitialized(_this), "sendOTP", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(resend, otpTypesent) {
        var chkbxval, email, modid, usrDatCook, glid, mob_cont_code, mobile_num, phCountry, process, verify_screen, params, res, message;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (resend == 0) {
                  if (otpTypesent === 1) {
                    chkbxval = 'mobile'; // _gaq.push(['_trackEvent', identifyForm, "Send OTP - Mobile Clicked", "MY", 0, 0]);
                  } else if (otpTypesent === 2) {
                    chkbxval = 'email'; // _gaq.push(['_trackEvent', identifyForm, "Send OTP - Email Clicked", "MY", 0, 0]);
                  }
                  ...
                  chkbxval = _this.state.chkbxval;
                }

                email = _this.props.data.email1;
                modid = 'MY';
                usrDatCook = Object(_Globals_CookieManager__WEBPACK_IMPORTED_MODULE_9__["getCookie"])("ImeshVisitor", 'object');
                glid = usrDatCook.glid;
                mob_cont_code = usrDatCook.phcc;
                mobile_num = usrDatCook.mb1;
                phCountry = usrDatCook.iso;
                process = 'BuyerMY_ForgetPassword_Desktop';
                verify_screen = 'Buyer My Change Password Page Desktop';
                params = {};
                ...
                if (chkbxval == 'mobile') {
                  params = {
                    ...
                    'flag': "OTPGen",
                    'user_ip': country_ip,
                    'user_country': phCountry,
                    'process': process,
                    'user_updatedusing': verify_screen,
                    "OTPResend": resend
                  };
                } else {
                  if (phCountry == 'IN') {
                ...
                // let url = "/miscreact/ajaxrequest/buyer/otpver/";
                // const res = await axios.post(url, params);


                _context.next = 16;
                return _this.props.sendOTP(params);

              case 16:
                res = {
                  data: _this.props.otpData
                };

                if (res.data && res.data.Response.Code == 200) {
                  message = res.data.Response.Message;

                  _this.setState({
                    showSetOTPDiv: false,
                    showCPotpEnter: true
                  }); // document.getElementById('setOTPDiv').style.display = 'none';
                  // document.getElementById('CPotpEnter').style.display = 'inline-block';


                  if (chkbxval == 'mobile') {
                    if (message === 'We have already sent an OTP on your mobile') {
                      _this.setState({
                        otpMsg: 'One Time Password already sent on mobile - ',
                        otpMedium: Object(_utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__["getMaskedMobile"])(_this.props.data.glusr_usr_ph_mobile)
                      }); // document.getElementById('OTPmessage').innerHTML = 'One Time Password already sent on mobile - <b>' +getMaskedMobile(this.props.data.glusr_usr_ph_mobile) + '</b>';

                    } else {
                      _this.setState({
                        otpMsg: 'One Time Password sent on mobile - ',
                        otpMedium: Object(_utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__["getMaskedMobile"])(_this.props.data.glusr_usr_ph_mobile)
                      }); // document.getElementById('OTPmessage').innerHTML = 'One Time Password sent on mobile - <b>' + getMaskedMobile(this.props.data.glusr_usr_ph_mobile) + '</b>';

                    }
                  } else {
                    _this.setState({
                      otpMsg: 'One Time Password sent on email - ',
                      otpMedium: Object(_utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__["getMaskedEmail"])(_this.props.data.email1)
                    }); // document.getElementById('OTPmessage').innerHTML = 'One Time Password sent on email - <b>' + getMaskedEmail(this.props.data.email1) + '</b>';
                  ...
                  _this.setState({
                    showOtpMsg: true,
                    showLoader: false,
                    showResendandReset: true
                  }); // document.getElementById('CPrsnd').style.display = 'block';
                  ...
                  _this.setState({
                    showLoader: false,
                    divError: 'Some problem occured. Please try again.',
                    showDivError: true
                  }); // $('#lod').css('display', 'none');
                  // $('#div_err').html('Some problem occured. Please try again.');
                  // $("#div_err").show();
    ...
    _defineProperty(_assertThisInitialized(_this), "chgPassword", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var chkbxval, email, modid, usrDatCook, glid, iso, mob_cont_code, mobile_num, phCountry, process, verify_screen, x, auth_key, auth, dataservice, res, message, code, imesh, v4iilex, im_iss, newCookie;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              chkbxval = _this.state.chkbxval; // if (otpTypesent === 1) {
              // 		chkbxval = 'mobile';
              // 		// _gaq.push(['_trackEvent', identifyForm, "Send OTP - Mobile Clicked", "MY", 0, 0]);
              // } else if (otpTypesent === 2) {
              // 		chkbxval = 'email';
              // 		// _gaq.push(['_trackEvent', identifyForm, "Send OTP - Email Clicked", "MY", 0, 0]);
              // }
              ...
              process = 'BuyerMY_ForgetPassword_Desktop';
              verify_screen = 'Buyer My Change Password Page Desktop';
              x = document.getElementsByClassName("mobbox2 f1 border_black1");
              auth_key = '';
              auth = new Array();
            ...
            case 19:
              ...
              if (chkbxval == 'mobile') {
                dataservice = {
                  ...
                  'pass': _this.state.new_pass,
                  'new_pass_reenter': _this.state.conf_pass
                };
              } else {
                dataservice = {
                  'att_id': 109,
              ...
              } // let url = "/miscreact/ajaxrequest/buyer/chgpassword/";
              // const res = await axios.post(url, dataservice);


              _context2.next = 23;
              return _this.props.changePassword(dataservice);

            case 23:
              res = {
                data: _this.props.changePasswordData
              }; // if(res.data.Response.Code==200){
              // 	document.getElementById('setOTPDiv').style.display = 'none';
              // 	document.getElementById('CPotpEnter').style.display = 'inline-block';
              // 	document.getElementById('OTPmessage').innerHTML = 'One Time Password sent on mobile - <b>' + this.props.data.glusr_usr_ph_mobile + '</b>';
              // 	document.getElementById('OTPmessage').style.display = 'block';
              // 	document.getElementById('CPrsnd').style.display = 'block';
              // 	document.getElementById('resetDiv').style.display = 'block';
              // }
              ...
              _this.setState({
                disabled: true
              }); // $('.CPsubmitbuttonOTP').attr('disabled', true);
              // $('.CPsubmitbuttonOTP').attr('style', '');


              message = '';

              if (typeof res.data.Response.message !== "undefined") {
                message = res.data.Response.message;
              } else if (typeof res.data.Response.Message !== "undefined") {
                message = res.data.Response.Message;
              }

              code = '';

              if (typeof res.data.Response.code !== "undefined") {
                code = res.data.Response.code;
              } else if (typeof res.data.Response.Code !== "undefined") {
                code = res.data.Response.Code;
              }

              if (code == 200 && message == 'Password Changed') {
                $('#firstOTPcharmobile, #secondOTPcharmobile, #thirdOTPcharmobile, #fourthOTPcharmobile').val(''); // $('#new_pass, #conf_pass').val('');
                ...
                _this.setState({
                  ...
                  showDivSucc: true,
                  displayPage: false
                }); // $("#CPotpEnter").css('display', 'none');
                // $("#CPrsnd").css('display', 'none');
                // $('#lod').css('display', 'none');
                // $("#setOTPDiv").css('display', 'block');
                // $("#resetDiv").css('display', 'none');
                // $('.mr20').css('display', 'none');
                // $('#div_succ').show();

                /* Set Cookie here */


                imesh = res.data.Response.LOGIN_DATA.DataCookie;
                v4iilex = res.data.Response.LOGIN_DATA.LoginCookie;
                im_iss = res.data.Response.LOGIN_DATA.im_iss; // console.log(imesh, v4iilex, im_iss);

                newCookie = objToStr(v4iilex); // console.log(newCookie);

                Object(_Globals_CookieManager__WEBPACK_IMPORTED_MODULE_9__["setCookie"])("v4iilex", newCookie, 30); // let expires = new Date();
                // expires.setTime(expires.getTime() + 24 * 60 * 60 * 180 * 1000);
                // document.cookie = "v4iilex=" + escape(newCookie) + ";" + "expires=" + expires.toGMTString() + ";" + "domain=localhost;path=/;";

                newCookie = objToStr(im_iss); // console.log(newCookie);

                Object(_Globals_CookieManager__WEBPACK_IMPORTED_MODULE_9__["setCookie"])("im_iss", newCookie, 30); // expires = new Date();
                // expires.setTime(expires.getTime() + 24 * 60 * 60 * 180 * 1000);
                // document.cookie = "im_iss=" + escape(newCookie) + ";" + "expires=" + expires.toGMTString() + ";" + "domain=localhost;path=/;";

                newCookie = objToStr(imesh); // console.log(newCookie);

                Object(_Globals_CookieManager__WEBPACK_IMPORTED_MODULE_9__["setCookie"])("ImeshVisitor", newCookie, 180); // expires = new Date();
                // expires.setTime(expires.getTime() + 24 * 60 * 60 * 180 * 1000);
                // document.cookie = "ImeshVisitor=" + escape(newCookie) + ";" + "expires=" + expires.toGMTString() + ";" + "domain=localhost;path=/;";
                // window.location.reload();
              }
              ...
              if (code == 204) {
                if (message == 'OTP not Verified') {
                  _this.setState({
                    divError: 'Entered One Time Password does not match.',
                    showDivError: true,
                    start: true,
                    showLoader: false
                  }); // $('#div_err').html('Entered One Time Password does not match.');
                  // $("#div_err").show();


                  $('#firstOTPcharmobile, #secondOTPcharmobile, #thirdOTPcharmobile, #fourthOTPcharmobile').val('');
                  $('#firstOTPcharmobile').focus(); // $("#start").attr('disabled', true);
                  // $("#start").attr("style", "");
                  // $('#lod').css('display', 'none');
                } else if (message == 'Update Service Failure') {
                  _this.setState({
                    divError: 'Existing Password does not match.',
                    showDivError: true,
                    start: true,
                    showLoader: false,
                    showCPotpEnter: false,
                    showResendandReset: false,
                    showSetOTPDiv: true
                  }); // $('#div_err').html('Existing Password does not match.');
                  // $("#div_err").show();


                  $('#firstOTPcharmobile, #secondOTPcharmobile, #thirdOTPcharmobile, #fourthOTPcharmobile').val('');
                  $('#firstOTPcharmobile').focus(); // $("#CPotpEnter").css('display', 'none');
                  // $("#CPrsnd").css('display', 'none');
                  // $("#setOTPDiv").css('display', 'block');
                  // $("#resetDiv").css('display', 'none');
                  ...
                  $('#firstOTPcharmobile, #secondOTPcharmobile, #thirdOTPcharmobile, #fourthOTPcharmobile').val(''); // $("#setOTPDiv").css('display', 'block');
                  // $("#resetDiv").css('display', 'none');
                  // $('#new_pass, #conf_pass').val('');
                  // $('#div_err').html(message);
                  // $("#div_err").show();
                  // $("#start").attr('disabled', true);
                  // $("#start").attr("style", "");
                  // $('#lod').css('display', 'none');
    ...
    _defineProperty(_assertThisInitialized(_this), "onOTPChange", function (e) {
      var x = document.getElementsByClassName("mobbox2 f1 border_black1");
      var auth_key = '';
      var auth = new Array();
    ...
    _defineProperty(_assertThisInitialized(_this), "getOTPJSX", function () {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, _this.state.showCPotpEnter && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "CPotpEnter",
        "class": "cpotpenter"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
        "class": "textfld2 fs14 fw c3 label1",
        id: "ch-label2"
      }, "Enter One Time Password : "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        name: "otp1",
        "class": "checkCPotpEnter mobbox2 f1 border_black1",
        type: "text",
        id: "firstOTPcharmobile",
        onChange: _this.onOTPChange,
        onKeypress: function onKeypress(e) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["chkInput"])(e);
        },
        onKeyup: function onKeyup(event) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["move_toNext1"])(event, 'firstOTPcharmobile', 'secondOTPcharmobile');
        },
        maxlength: "1",
        autofocus: ""
        ...
        "class": "checkCPotpEnter mobbox2 f1 border_black1",
        type: "text",
        id: "secondOTPcharmobile",
        onChange: _this.onOTPChange,
        onKeypress: function onKeypress(e) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["chkInput"])(e);
        },
        onKeyup: function onKeyup(event) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["move_toNext1"])(event, 'secondOTPcharmobile', 'thirdOTPcharmobile');
        },
        maxlength: "1"
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        name: "otp3",
        "class": "checkCPotpEnter mobbox2 f1 border_black1",
        type: "text",
        id: "thirdOTPcharmobile",
        onChange: _this.onOTPChange,
        onKeypress: function onKeypress(e) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["chkInput"])(e);
        },
        onKeyup: function onKeyup(event) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["move_toNext1"])(event, 'thirdOTPcharmobile', 'fourthOTPcharmobile');
        },
        maxlength: "1"
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        name: "otp4",
        ...
        onKeyup: function onKeyup(event) {
          return Object(_Globals_GlobalFunc__WEBPACK_IMPORTED_MODULE_8__["move_toNext1"])(event, 'fourthOTPcharmobile', '');
        },
        autocomplete: "off"
        ...
        id: "CPswitchnew",
        "class": "resend resend1"
      }, "Get OTP via other Option"))), _this.state.showOtpMsg && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "OTPmessage"
      }, _this.state.otpMsg, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, _this.state.otpMedium)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", {
        "class": "didRcvnew"
      }, _this.state.showResendandReset && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
        id: "CPrsnd",
        onClick: function onClick(e) {
          return _this.sendOTP(1);
        },
        "class": "resend"
      }, " Resend"))), _this.state.showResendandReset && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "resetDiv"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        type: "submit",
        name: "start",
        id: "start",
        value: "Submit",
        "class": "CPsubmitbutton",
        disabled: _this.state.start,
        style: !_this.state.start && "background: ".concat(_this.state.startBg, "; border: 1px solid #eae8e8;padding: 10px 20px;"),
        tabindex: "4",
        onClick: _this.chgPassword
      })));
    });
  ...
  _createClass(PasswordComponent, [{
    ...
    function componentDidMount() {
      var st = _Redux_store__WEBPACK_IMPORTED_MODULE_4__["store"].getState();
    ...
    value: function render() {
      ...
      return this.props.data.glusr_disabled_reason == '1' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "disableUser"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "fnt24"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("img", {
        src: "https://my.imimg.com/gifs_new/tdr-alert.gif"
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), "Something is Wrong."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", null, "Sorry for the inconvenience. Please try again later."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("a", {
        href: "https://my.indiamart.com",
        "class": "btn-buyer mrgLft"
      }, "Go to Home Page"))) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: "hm1 bbc fxmn"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: "content-wrapper"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "fixed_sec"
      }, this.props.loader === 1 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_loader_components_LoaderAnimation__WEBPACK_IMPORTED_MODULE_2__["default"], {
        style: {
          margin: "auto",
          left: "0",
          right: "0",
      ...
      }) : this.props.fail == 1 || this.props.data.CODE != undefined && this.props.data.CODE != '200' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ErrorPage_components_error__WEBPACK_IMPORTED_MODULE_11__["error"], null) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(react__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(TabNav, this.props), this.state.showDivSucc && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "div_succ",
        "class": "pa succ_box bnr"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("i", {
        "class": "c dntrk"
      }), "Thank You. ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("br", null), "Your Password has been changed successfully."), this.state.displayPage && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "mr20 m10"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "ch-pwd"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        ...
        "class": "textfld2 fs14 fw c3",
        id: "ch-label1"
      }, "New Password :"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        maxlength: "60",
        name: "new_pass",
        id: "new_pass",
        ...
        onChange: function onChange(e) {
          return _this2.onChangeHandle(e);
        },
        onBlur: this.checkPass,
        onKeyUp: this.checkPass
      }), "\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        type: "checkbox",
        onClick: this.showPassword
      }), " Show Password")), this.state.showPassError && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
        "class": "err-ch",
        id: "new_pass_err"
      }, this.state.passError), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
        "class": "textfld2 fs14 fw c3",
        id: "ch-label2"
      }, "Re-Enter New Password :"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        maxlength: "60",
        ...
        tabindex: "3",
        onBlur: this.checkConfPass,
        onKeyUp: this.checkConfPass
      }), this.state.showConfPassError && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
        "class": "err-ch",
        id: "con_pass_err"
      }, this.state.confPassError)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "tc"
      }, this.state.showSetOTPDiv && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "setOTPDiv"
      }, this.props.data.glusr_usr_ph_mobile && this.props.data.glusr_usr_ph_mobile != '' && this.props.data.country_iso && this.props.data.country_iso == 'IN' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "otpsendmsgdiv"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        type: "button",
        name: "CPRequestOTPmobile",
        id: "CPRequestOTPmobile",
        value: "Send One Time Password via SMS",
        "class": "CPsubmitbutton CPsubmitbuttonOTP ".concat(!this.state.disabled && 'CPsubmitbuttonOTP1'),
        tabindex: "4",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this2.sendOTP(0, 1);
        }
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
        "class": "CPsubmitbuttonOTPLabel"
      }, "One Time Password will be sent on ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, Object(_utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__["getMaskedMobile"])(this.props.data.glusr_usr_ph_mobile)))), this.props.data.glusr_usr_ph_mobile && this.props.data.glusr_usr_ph_mobile != '' && this.props.data.country_iso && this.props.data.country_iso == 'IN' && this.props.data.email1 && this.props.data.email1 != '' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "orDiv"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
        "class": "CPsubmitbuttonOTPLabel orDivlabel"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", null, "OR"))), (this.props.data.country_iso && this.props.data.country_iso == 'IN' && this.props.data.email1 && this.props.data.email1 != '' || this.props.data.country_iso != 'IN') && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        "class": "emailDiv"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
        type: "button",
        name: "CPRequestOTPemail",
        id: "CPRequestOTPemail",
        value: "Send One Time Password via Email",
        "class": "CPsubmitbutton CPsubmitbuttonOTP ".concat(!this.state.disabled && 'CPsubmitbuttonOTP1'),
        tabindex: "4",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this2.sendOTP(0, 2);
        }
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", {
        "class": "CPsubmitbuttonOTPLabel"
      }, "One Time Password will be sent on ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("b", {
        "class": "maskedEmail"
      }, this.props.data && Object(_utility_PasswordUtility__WEBPACK_IMPORTED_MODULE_7__["getMaskedEmail"])(this.props.data.email1))))), this.getOTPJSX(), this.state.showLoader && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", {
        id: "lod",
        "class": "ldr-im"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
        "class": "spinner1"
      }), " Please wait.. "), this.state.showDivError && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        id: "div_err",
        "class": "pa bnr succ_boxerr"
      }, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("i", {
        "class": "dnterr c"
      }), this.state.divError)))))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Footer_components_Footer__WEBPACK_IMPORTED_MODULE_1__["footNav"], null));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (PasswordComponent);

/***/ }),

/***/ "./src/modules/Buyer/ChangePassword/container/PasswordContainer.js":
/*!*************************************************************************!*\
  !*** ./src/modules/Buyer/ChangePassword/container/PasswordContainer.js ***!
  \*************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_Password__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Password */ "./src/modules/Buyer/ChangePassword/components/Password.js");
/* harmony import */ var _Redux_UserDetails_UDActions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../Redux/UserDetails/UDActions */ "./src/Redux/UserDetails/UDActions.js");
/* harmony import */ var _Redux_ChangePassword_CPActions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../Redux/ChangePassword/CPActions */ "./src/Redux/ChangePassword/CPActions.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  return _objectSpread(_objectSpread({}, state.UserDetails), state.ChangePassword);
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    // fetchData: () => dispatch(fetchSetting_Data()),
    fetchUserData: function fetchUserData() {
      return dispatch(Object(_Redux_UserDetails_UDActions__WEBPACK_IMPORTED_MODULE_2__["fetchUDData"])());
    },
    sendOTP: function sendOTP(params) {
      return dispatch(Object(_Redux_ChangePassword_CPActions__WEBPACK_IMPORTED_MODULE_3__["sendOTP"])(params));
    },
    changePassword: function changePassword(params) {
      return dispatch(Object(_Redux_ChangePassword_CPActions__WEBPACK_IMPORTED_MODULE_3__["changePassword"])(params));
    } // fetchUserData: () => fetchUDData()

  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispatchToProps)(_components_Password__WEBPACK_IMPORTED_MODULE_1__["default"]));

/***/ }),

/***/ "./src/modules/Buyer/ChangePassword/css/Password.css":
/*!***********************************************************!*\
  !*** ./src/modules/Buyer/ChangePassword/css/Password.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/modules/Buyer/ChangePassword/utility/PasswordUtility.js":
/*!*********************************************************************!*\
  !*** ./src/modules/Buyer/ChangePassword/utility/PasswordUtility.js ***!
  \*********************************************************************/
/*! exports provided: getMaskedMobile, getMaskedEmail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMaskedMobile", function() { return getMaskedMobile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMaskedEmail", function() { return getMaskedEmail; });
function getMaskedMobile(mobile) {
  if (!mobile) return '';
  return "*".repeat(mobile.length - 4) + mobile.substr(mobile.length - 4);
}

function getMaskedEmail(email) {
  if (!email) return '';
  return email.substr(0, 1) + "*".repeat(email.indexOf('@') - 1) + email.substr(email.indexOf('@'));
}
...
//# sourceMappingURL=ChangePassword.pwa202.js.map