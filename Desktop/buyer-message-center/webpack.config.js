...
const assetsPathHandler = (function () {
  ...
  if (process.env.NODE_ENV_M == "prod" || process.env.NODE_ENV_M == 'prod_test') {
    assetsPath = {
      chunkServePath: "https://my.imimg.com/pwagifs/",
      buildMode: "production",
    };
  } else if (process.env.NODE_ENV_M == "stg") {
    assetsPath = {
      chunkServePath: "https://stg-my.imimg.com/pwagifs/",
      buildMode: "production",
    };
  } else if (process.env.NODE_ENV_M == "dev") {
    assetsPath = {
      chunkServePath: "https://dev-my.imimg.com/pwagifs/",
...
function config(mainJSNumber, jsChunkNumber, cssChunkNumber, chunksWritePath) {
  ...
  assetsPathHandler.devtool
    ? (webpackConf["devtool"] = assetsPathHandler.devtool)
    : "";
  return webpackConf;
}
